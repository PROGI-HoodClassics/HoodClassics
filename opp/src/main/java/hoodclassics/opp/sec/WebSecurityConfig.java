...
public class WebSecurityConfig {
	...
	public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
		http
			.csrf(AbstractHttpConfigurer::disable) // TODO: Naći bolji način za "odzabraniti" (ne vratiti 403) POST requestove
	...
	private OAuth2UserService<OAuth2UserRequest, OAuth2User> oauth2UserService() {
		...
		return userRequest -> {
			...
			User newUser = new User(name, surname, email, username);
	...
	public ClientRegistrationRepository clientRegistrationRepository() {
 	...
 	private ClientRegistration googleClientRegistration() {
 		return ClientRegistration.withRegistrationId("google")
 			...
 			.scope("profile", "email")                               //openid NI POD KOJU CIJENU ne smije tu biti
